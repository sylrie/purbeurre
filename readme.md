...
<p align="center">
  <strong>The goal of Pur Beurre is to create a platform with the Open Food Facts database <br>
  for compare food and propose a healthier substitute.</strong>
</p>
...
<p align="center">
    <img width=50% src="https://github.com/sylrie/P8_Pur_beurre_platform/blob/master/docs/screenshot2.png">
</p>